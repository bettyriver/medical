...
write.csv(summary_tbl_srm, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_Table7quantative negative.csv", row.names = FALSE)
...
summary_tbl_srm <- purrr::map_dfr(sheets, analyze_sheet_srm)
print(summary_tbl_srm)
write.csv(summary_tbl_srm, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_Table7quantative positive.csv", row.names = FALSE)
...
summary_tbl_srm <- purrr::map_dfr(sheets, analyze_sheet_srm)
print(summary_tbl_srm)
write.csv(summary_tbl_srm, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_Table8Semi-quantative negative.csv", row.names = FALSE)
...
summary_tbl_srm <- purrr::map_dfr(sheets, analyze_sheet_srm)
print(summary_tbl_srm)
write.csv(summary_tbl_srm, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_Table8Semi-quantative positive.csv", row.names = FALSE)
...
summary_tbl_srm <- purrr::map_dfr(sheets, analyze_sheet_srm)
print(summary_tbl_srm)
write.csv(summary_tbl_srm, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_Table9.csv", row.names = FALSE)
