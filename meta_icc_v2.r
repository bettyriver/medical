...
# Number (study id), effect_id, ICC_value_final (or 'estimate'), ICC_SE_final (SE on ICC scale)
analyze_sheet_icc <- function(sheet_name, path = excel_path,
                              est_col = "ICC_value_final",
                              se_col  = "ICC_SE_final") {
...
# table 3
excel_path <- "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/Table 3.xlsx"
...
write.csv(icc_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_table3.csv", row.names = FALSE)



# table 4
excel_path <- "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/Table 4.xlsx"
sheets <- readxl::excel_sheets(excel_path)
sheets
icc_summary   <- purrr::map_dfr(sheets, ~analyze_sheet_icc(.x))
...
print(icc_summary)
# Optional: write results
write.csv(icc_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_table4.csv", row.names = FALSE)
...
print(icc_summary)
# Optional: write results
write.csv(icc_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_FNIHICC.csv", row.names = FALSE)
...
print(icc_summary)
# Optional: write results
write.csv(icc_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_treatmemtICC.csv", row.names = FALSE)
