...
print(summary_tbl)
write.csv(summary_tbl, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_Table1.csv", row.names = FALSE)
...
summary_tbl <- purrr::map_dfr(sheets, analyze_sheet)
print(summary_tbl)
write.csv(summary_tbl, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_Table2.csv", row.names = FALSE)
...
summary_tbl <- purrr::map_dfr(sheets, analyze_sheet)
print(summary_tbl)
write.csv(summary_tbl, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_FNIHCV.csv", row.names = FALSE)
