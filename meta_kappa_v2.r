...
write.csv(kappa_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_table5.csv", row.names = FALSE)
...
print(kappa_summary)
# Optional: write results
write.csv(kappa_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_table6.csv", row.names = FALSE)
...
print(kappa_summary)
# Optional: write results
write.csv(kappa_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_FNIHKappa.csv", row.names = FALSE)
...
print(kappa_summary)
# Optional: write results
write.csv(kappa_summary, "/Users/ymai0110/Documents/medical_data/R/Rtable_Nov02/result_v2/result_treatmentKappa.csv", row.names = FALSE)
